...
<table border="2" rules="cols" align="center" cellpadding="5" cellspacing="5" bgcolor="#b300b3">
	<tr>
		<td align="center">
...
if(isset($_POST['sb']))
{
	...
	mysqli_query($con,"insert into product(pnm,pimg,detail)value('$pnm','$pi','$det')")or die(mysqli_error($con));
